...
""" % (config, val_list[0])
    ...
    def update_hive_site(self):
        try:
            ...
            if not os.path.exists(preunravel_hive_site):
            ...
            for config, val_list in self.configs['hive-site'].iteritems():
                ...
                for property in root.findall('property'):
                    ...
                    if val_list[0] in property_value.text and property_name.text == config:
                        ...
                        print("{:10} {:>{width}}".format(config, "incorrect, updating", width=80-len(config)))
                        ...
                        find_property = True
                        tree.write(hive_site_xml)
                        break
                if not find_property:
                    print("{:10} {:>{width}}".format(config, "missing, appending", width=80-len(config)))
    ...
    def update_hive_env(self):
        ...
        try:
            ...
            elif not os.path.exists(preunravel_hive_env):
    ...
    def update_spark_defaults(self):
        ...
        try:
            ...
            if not os.path.exists(preunravel_spark_default):
    ...
    def update_hadoop_env(self):
        ...
        try:
            ...
            if not os.path.exists(preunravel_hadoop_env):
...
def main():
    ...
    if deploy_sensor_result[0] == True:
    ...
    if deploy_sensor_result[1] == True:
    ...
    print("\nUnravel Sensor installation and intrumentation completed\n")
